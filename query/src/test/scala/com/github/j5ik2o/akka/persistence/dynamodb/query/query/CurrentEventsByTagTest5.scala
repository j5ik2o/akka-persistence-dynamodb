...
class DynamoDBCurrentEventsByTagTest5
    extends CurrentEventsByTagTest5(
      ConfigFactory
        .parseString(
         ...
         |  query-batch-size = 1
         |  dynamo-db-client {
         |    endpoint = "http://${DynamoDBCurrentEventsByTagTest5.dynamoDBHost}:${DynamoDBCurrentEventsByTagTest5.dynamoDBPort}/"
         |  }
         |}
         |
  ...
  override protected lazy val dynamoDBHost: String = DynamoDBCurrentEventsByTagTest5.dynamoDBHost
