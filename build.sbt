...
lazy val `base-v2` = (project in file("base/base-v2"))
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "software.amazon.dax"                % "amazon-dax-client" % "2.0.2",
      logback.classic                      % Test,
      slf4j.julToSlf4J                     % Test,
      dimafeng.testcontainerScalaScalaTest % Test
    )
...
lazy val example = (project in file("example"))
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.github.j5ik2o"                    %% "docker-controller-scala-scalatest"      % "1.14.104",
      "com.github.j5ik2o"                    %% "docker-controller-scala-dynamodb-local" % "1.14.104"
    )
  )
  .dependsOn(
    test,
