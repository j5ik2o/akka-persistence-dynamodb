...
|table | Snapshot | `persistence-id` (String) | `sequence-nr` (Number) | Required when using the snapshot feature with [EventSourcedBehavior](https://doc.akka.io/docs/akka/current/typed/index-persistence.html). |
